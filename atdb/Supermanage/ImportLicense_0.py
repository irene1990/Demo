...
class Untitled(unittest.TestCase):
    ...
    def test_untitled(self):
        driver = self.driver
        driver.get("http://192.168.82.34/dbackup/")
        ...
        self.assertEqual(u"鼎甲迪备备份服务器", driver.title)
        driver.find_element_by_id("licenses_upload").click()
        driver.find_element_by_id("upload_licenses_file").clear()
        driver.find_element_by_id("upload_licenses_file").send_keys("/home/irene/Downloads/license_20150709063050_.key")
