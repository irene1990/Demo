...
class Untitled(unittest.TestCase):
    ...
    def test_untitled(self):
        ...
        self.assertEqual(u"鼎甲迪备备份服务器", driver.title)
        driver.find_element_by_id("datafileRadio").click()
        driver.find_element_by_xpath("//div[@id='wizard-1']/div/div[3]/div[4]/label").click()
        driver.find_element_by_id("datafileChecbox").click()
        ...
        driver.find_element_by_id("jobName").send_keys(u"表空间累积差异备份")
