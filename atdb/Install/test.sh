#!/usr/bin/expect
set timeout 30
spawn scp Download/GetPackages.py Download/LANG.py Download/try.py Server/Ubuntu_dbackup3.sh  Server/Ubuntu_server.sh Server/Ubuntu_RN.sh ../Uninstall/Server/UninstallDEB.py root@192.168.82.40:/root
